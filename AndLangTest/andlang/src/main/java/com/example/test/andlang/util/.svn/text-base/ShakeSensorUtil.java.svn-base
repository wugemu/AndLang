 ...
 */
public class ShakeSensorUtil implements SensorEventListener {
    ...
    public ShakeSensorUtil(Context context) {
        this(context, ShakeSensorUtil.DEFAULT_SHAKE_SPEED);
    }
     ...
     */
    public ShakeSensorUtil(Context context, int speedShreshold) {
        mContext = context;
